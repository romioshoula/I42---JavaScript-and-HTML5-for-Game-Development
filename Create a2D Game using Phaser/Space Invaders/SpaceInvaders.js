//SapceInvaders.js RamiWailShoula
(function(){
  ...
  Class.extend = function(prop) {
    ...
    // Constructor Dummy
    function Class() {
      // All construction via init
      if ( !initializing && this.init )
        this.init.apply(this, arguments);
    }
    // Populate prototype object
    Class.prototype = prototype;
    // Enforcing constructor
...
var SPRITE_SHEET_SRC = './S_I_Spritesheet.jpg';
var LEFT_KEY = 37;  //Left Arrow Key
var RIGHT_KEY = 39; //Right Arrow Key
var SHOOT_KEY = 38; //Up Arrow Key
...
// Resource manipulation funcs and classes
...
var Player = SheetSprite.extend({
  ...
  update: function(dt) {
    ...
    // keep player position in screen bounds
...
var Enemy = SheetSprite.extend({
  init: function(clipRects, x, y) {
    ...
    this.stepDelay = 1; // step delay for enemies
...
function initCanvas() {
  ...
  // create main sprite sheet img
  spriteSheetImg = new Image();
  spriteSheetImg.src = SPRITE_SHEET_SRC;  
  preDrawImages();
  // event listeners and resize initially
...
// Helpful Input functions checkers
